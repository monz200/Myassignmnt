...
public class EditLead {
	...
	public static void createLead(ChromeDriver driver)
	{
		...
		driver.findElement(By.xpath("//td/input[@name='firstName']")).sendKeys("Mohanapriya");
		driver.findElement(By.xpath("//td/input[@name='lastName']")).sendKeys("Mahalingam");
		driver.findElement(By.xpath("//td/input[@name='firstNameLocal']")).sendKeys("Mohanapriya M");
